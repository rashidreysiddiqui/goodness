    ...
    <div className="bg-white">
      <section className="bg-[#001F54] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">We'd love to hear from you. Reach out to us for any questions, partnerships, or ways to get involved.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-[#32CD32] hover:bg-[#28A228]">
                  Send Message
                </Button>
              </form>
            </div>
